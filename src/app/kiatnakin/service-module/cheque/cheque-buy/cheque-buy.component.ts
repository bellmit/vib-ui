...
export class ChequeBuyComponent implements OnInit, AfterViewInit {
    ...
    constructor(private router: Router,
        ...
        this.data.receiver_idcard = this.userService.getUser().idNumber || 1111111111119;
        this.data.receiver_first_name = this.userService.getUser().nameTH || "สมปอง";
        this.data.receiver_last_name = this.userService.getUser().surenameTH || "มาดี";
    ...
    public checkRecipt_type(num: string) {
        ...
        if (num === "0") {
            ...
            this.data.receiver_idcard = this.userService.getUser().idNumber;
            this.data.receiver_first_name = this.userService.getUser().nameTH;
            this.data.receiver_last_name = this.userService.getUser().surenameTH;
